          ...
          if (this.props.options.persistTableData) {
            props = (0, _objectSpread2["default"])({}, props, {
              columns: props.columns.map(function (column) {
                var columnData = _this3.state.columns.find(function (_ref) {
            ...
            calculatedProps.actions.push({
              ...
              onClick: function onClick() {
                ...
                _this4.setState(
                  (0, _objectSpread2["default"])(
                    {},
                    _this4.dataManager.getRenderState(),
                    {
...
var ScrollBar = (0, _core.withStyles)(style)(function (_ref2) {
  var _double = _ref2["double"],
